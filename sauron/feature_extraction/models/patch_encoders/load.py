...
from sauron.feature_extraction.models.patch_encoders.utils.constants import (
    get_constants,
)
from sauron.feature_extraction.models.patch_encoders.utils.transform_utils import (
    get_eval_transforms,
)
...
class CTransPathInferenceEncoder(BasePatchEncoder):
    ...
    def _build(self):
        ...
        try:
            from sauron.feature_extraction.models.patch_encoders.zoo.ctranspath.ctran import (
                ctranspath,
            )
        except:
            traceback.print_exc()
...
class Conchv15InferenceEncoder(BasePatchEncoder):
    ...
    def _build(self, img_size=448):
        from sauron.feature_extraction.models.patch_encoders.zoo.conchv1_5.conchv1_5 import (
