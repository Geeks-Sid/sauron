# sauron/feature_extraction/cli_runner.py (This replaces your root feature_extract script)
import argparse
import logging
import os
import sys
...
from sauron.feature_extraction.concurrency import batch_consumer, batch_producer
...
from sauron.parse.cli_parsers import parse_feature_extraction_arguments
...
if __name__ == "__main__":
    ...
    # For package usage, `sauron.cli:feature_extract_main` will be called.
