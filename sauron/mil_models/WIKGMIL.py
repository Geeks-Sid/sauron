# This is a modified version of the WiKG model from the WiKG paper.
# The original code is available at https://github.com/WonderLandxD/WiKG/blob/main/model.py
...
class WiKG(nn.Module):
    ...
    def forward(self, x):
        ...
        topk_index_expanded = topk_index.expand(
            e_t.size(0), -1, -1
        )  # shape: [1, 10000, 4]
